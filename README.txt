...
Пакеты:
    main: functions.py - основной модуль, содержащий функции
для решения правктического задания.
    prof: дублирует пакет main за одним исключением: профилирование через cProfile производится с помощью декоратора
